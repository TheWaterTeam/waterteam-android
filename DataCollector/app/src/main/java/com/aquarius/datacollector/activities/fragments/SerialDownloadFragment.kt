...
class SerialDownloadFragment : Fragment(), ControlListener {

    private var connectedProbeUUID: String? = null
    private var downloadRequestTime: Long = 0


    private var deviceConnection : GattConnection? = null;
 ...
 */
    ...
    private val mUsbReceiver = object : BroadcastReceiver() {
        override fun onReceive(context: Context, intent: Intent) {
            ...
            when (intent.action) {
                ...
                UsbService.ACTION_USB_ATTACHED -> handler.postDelayed({
                    usbConnected = true;
    ...
    private var mHandler: SerialDownloadFragment.MyHandler? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mHandler = SerialDownloadFragment.MyHandler(this)
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        */
        ...
        requestDownloadButton.setOnClickListener {
            this@SerialDownloadFragment.downloadRequestTime = System.currentTimeMillis() / 1000L
    ...
    fun sendCommand(command: String) {
        ...
        if (usbConnected && usbService != null) { // if UsbService was correctly binded, Send data
            usbService!!.write(command.toByteArray())
        } else if(bleConnected){
            launch(UI){
                deviceConnection?.sendToSerial(command);
            }
        }
    }
    ...
    private val serialTXCharacteristicUUID = UUID.fromString("6E400002-B5A3-F393-E0A9-E50E24DCCA9E")
    ...
    private suspend fun GattConnection.subscribeToSerialNotifications() {
        val service = getService(uartServiceUUID)
                ?: throw IllegalStateException("service not found")
    ...
    override fun onResume() {
        ...
        operationAttempt = launch(UI) {
            ...
            try {
                ...
                deviceConnection?.subscribeToSerialNotifications()
...
/*                 deviceConnection.notifyChannel.consumeEach {
                ...
                bleConnected = !usbConnected

                Timber.i("Done somehow! " + bleConnected.toString())
            ...
            /*device.useBasic(connectionTimeoutInMillis) { device, services ->
                ...
                with(GenericAccess) {
                    ...
                    device.subscribeToSerialNotifications()
                }
     ...
     */
    private class MyHandler(fragment: SerialDownloadFragment) : Handler() {
        private val mFragment: WeakReference<SerialDownloadFragment>
